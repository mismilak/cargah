...
urlpatterns = [
    ...
    path('<int:workshop_id>/management/delete/<int:service_id>/', views.service_delete, name='service_delete'),
    path('<int:workshop_id>/management/edit/<int:service_id>/', views.service_edit, name='service_edit'),
